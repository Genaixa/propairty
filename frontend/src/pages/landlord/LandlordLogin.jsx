      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-10 w-full max-w-md">
        ...
        <div className="mt-6 rounded-xl border border-emerald-100 bg-emerald-50 px-4 py-3">
          <div className="flex items-center justify-between mb-2">
            <p className="text-xs font-semibold text-emerald-700 uppercase tracking-wide">Demo access</p>
            <button
              type="button"
              onClick={() => { setEmail('robert@morrisonproperty.co.uk'); setPassword('demo1234') }}
              className="text-xs text-emerald-600 hover:text-emerald-800 font-medium hover:underline"
            >
              Fill in
            </button>
          </div>
          <p className="text-xs text-emerald-600 font-mono">robert@morrisonproperty.co.uk</p>
          <p className="text-xs text-emerald-500 font-mono">demo1234</p>
        </div>
